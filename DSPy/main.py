...
def build_dataset(base_path, max_files_per_company=10):
    dataset = []
    ...
    for company in os.listdir(base_path):
        ...
        files = sorted(os.listdir(company_path))[:max_files_per_company]
...
dataset = build_dataset("C:/Users/Vaishali/Desktop/DSPy/cleaned_ECTs_dataset", max_files_per_company=5)

print("Total transcripts loaded:", len(dataset))
